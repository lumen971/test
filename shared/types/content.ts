...
export interface ArticleDetail extends ArticleSummary { blocks: ArticleBlock[]; relatedArticles?: ArticleSummary[]; seoTitle?: string; seoDescription?: string; noIndex?: boolean }
