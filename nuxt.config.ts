export default defineNuxtConfig({
  ...
  nitro: { preset: 'vercel' },
  css: ['@fortawesome/fontawesome-svg-core/styles.css', '~/assets/css/main.css', '~/assets/css/brand-assets.css', '~/assets/css/hero-background.css', '~/assets/css/about-page.css', '~/assets/css/about-character.css', '~/assets/css/supporters-page.css', '~/assets/css/events-page.css', '~/assets/css/notion-content.css', '~/assets/css/scroll-effects.css'],
  runtimeConfig: {
    notionToken: '',
